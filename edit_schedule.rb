...
if $st != 's'
  ...
  print '<link rel="stylesheet" href="jquery.datetimepicker.css">' + "\n"
  print '<link rel="stylesheet" href="add_schedule.css">' + "\n"
  print '<script src="js/jquery.js"></script>' + "\n"
  print '<script src="js/jquery.datetimepicker.js"></script>' + "\n"
  print '<script src="js/build/jquery.datetimepicker.full.js"></script>' + "\n"
  ...
  # print '  <FORM name="form1" action="/cgi-bin/cal/add_schedule.rb" onSubmit="return false">' + "\n"
  ...
  print '  <br>' + "\n"
  print "<div id = \"buttom\" align=\"right\" style=\"clear:both;\"></div>"
  print "<form action=\"/cgi-bin/cal/add_schedule.rb"
  print "\" method=\"post\">\n "
